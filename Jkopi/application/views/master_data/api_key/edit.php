                        ...
                        <div class="card shadow-none mb-4">
                            ...
                            <div class="card-body">
                                <div class="form-group col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <input class="form-control" id="nama_api" name="nama_api" type="text" placeholder="Masukkan nama API" value="<?= $API->nama_api ?>" />
                                    <?= form_error('nama_api', '<small class="text-danger pl-2">', '</small>'); ?>
                                </div>
                                <div class="form-group col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                    <label class="small mb-1" for="url">URL</label>
                                    <input class="form-control" id="url" name="url" type="text" placeholder="Masukkan URL" value="<?= $API->url ?>" />
                                    <?= form_error('url', '<small class="text-danger pl-2">', '</small>'); ?>
                                </div>
                                <div class="form-group col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                    <label class="small mb-1" for="token">Token</label>
                                    <input class="form-control" id="token" name="token" type="text" placeholder="Masukkan token" value="<?= $API->token ?>" />
