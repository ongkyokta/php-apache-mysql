                                ...
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        <div class="text-center">
                                            <img class="img-account-profile mb-2" id="preview" src="<?= base_url() . $JEvent->gambar ?>" alt="" />
                                    ...
                                    <div class="form-group">
                                        <div class="form-group col-md-12">
                                            <div class="form-group">
                                                <label class="small mb-1" for="judul">Judul Event</label>
                                                <input class="form-control" id="judul" name="judul" type="text" placeholder="Masukkan judul event" maxlength="255" value="<?= $JEvent->judul_berita ?>" />
                                    ...
                                    <div class="form-group">
                                        <div class="form-group col-md-12">
                                            <label class="small mb-1" for="status">Status Event</label>
                                            <select class="form-control" id="status" name="status">
                                                <?php if ($JEvent->aktif == 'aktif') { ?>
                                    ...
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="deskripsi" name="deskripsi" type="text" placeholder="Masukkan deskripsi event" rows="10"><?= $JEvent->deskripsi ?></textarea>
