								...
								<div class="col-xl-12">
									<div class="form-group">
										<div class="text-center">
											...
											<label class="btn btn-secondary" type="button" for="gambar">Pilih Foto Berita</label>
									...
									<div class="form-group">
										<div class="form-group">
											<label class="small mb-1" for="nama">Judul Berita</label>
											<input class="form-control" id="judul" name="judul" type="text" placeholder="Masukkan judul berita" maxlength="255" value="<?= isset($_POST["judul"]) ? $_POST["judul"] : ''; ?>" />
