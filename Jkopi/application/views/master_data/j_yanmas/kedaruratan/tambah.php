                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row px-2">
                                    <div class="form-group col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <input class="form-control" id="nama" name="nama" type="text" placeholder="Masukkan nama dinas" maxlength="255" value="<?= isset($_POST["nama"]) ? $_POST["nama"] : ''; ?>" />
                                        <?= form_error('nama', '<small class="text-danger pl-2">', '</small>'); ?>
                                    </div>
                                    <div class="form-group col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        <label class="small mb-1" for="no_telp">Nomor Telepon</label>
                                        <input class="form-control" id="no_telp" name="no_telp" type="text" placeholder="Masukkkan Nomor Telepon" value="<?= isset($_POST["no_telp"]) ? $_POST["no_telp"] : ''; ?>" onkeypress="return onlyNumber(event)" />
