                            ...
                            <div class="row align-items-center justify-content-between">
                                <div class="col-auto mt-4">
                                    <h1 class="page-header-title">
                                        ...
                                        Edit Data Aplikasi Jember Kueren
                                    </h1>
                                ...
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        <div class="text-center">
                                            <img class="img-account-profile mb-2" id="preview" src="<?= base_url() . $JDer->gambar ?>" alt="" />
                                    ...
                                    <div class="form-group col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <input class="form-control" id="nama_aplikasi" name="nama_aplikasi" type="text" value="<?= $JDer->nama_aplikasi ?>" />
                                    ...
                                    <div class="form-group col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <input class="form-control" id="url" name="url" type="text" value="<?= $JDer->url ?>" />
                                        <?= form_error('url', '<small class="text-danger pl-2">', '</small>'); ?>
                                    </div>
                                    <div class="form-group col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                        <label class="small mb-1" for="deskripsi">Deskripsi Aplikasi</label>
                                        <textarea class="form-control" id="deskripsi" name="deskripsi" type="text" rows="10"><?= $JDer->deskripsi ?></textarea>
