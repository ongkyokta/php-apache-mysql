          ...
          <form method="POST" enctype="multipart/form-data">
            <div class="card shadow-none card-header-actions mx-auto mb-4">
              <div class="card-header">
                <a class="btn btn-primary btn-sm shadow-sm" href="<?= base_url("master_data/Ecommerce/tambah_kategori") ?>">
                  Tambah Data
                </a>
              </div>
              <div class="card-body">
      ...
      success: function(data) {
        ...
        for (var i = 0; i < data.length; i++) {
          baris += '<tr>' +
            ...
            '<td> <a href="edit_kategori/' + data[i].id_kategori + '" class="btn btn-datatable btn-icon btn-transparent-dark"><i class="fa fa-pencil-alt"></i></a> <a class="delete btn btn-datatable btn-icon btn-transparent-dark" data-id="' + data[i].id_kategori + '" href="javascript:void(0)"><i class="fa fa-trash"></i></a></td>'
          '</tr>'
        }
  ...
  $(document).ready(function() {
    $('#target').on('click', '.delete', function(event) {
      ...
      $('#delete_link').click(function(e) {
        ...
        $.ajax({
          url: '<?= base_url('master_data/Ecommerce/delete_kategori') ?>',
          type: 'POST',
          data: {
            id: deleteid
          },
