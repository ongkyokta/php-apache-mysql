              ...
              <div class="card-body">
                <div class="form-group">
                  <div class="text-center">
                    ...
                    <label class="btn btn-secondary" type="button" for="gambar">Pilih Foto Kategori E-Commerce</label>
                ...
                <div class="form-row px-2">
                  <div class="form-group col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    ...
                    <input class="form-control" id="nama_kategori" name="nama_kategori" type="text" placeholder="Masukkan nama kategori E-Commerce" value="<?= $Kategori->nama_kategori; ?>" />
