							...
							<div class="row align-items-center justify-content-between">
								<div class="col-auto mt-4">
									<h1 class="page-header-title">
										<div class="page-header-icon"><i data-feather="hard-dve"></i></div>
						...
						<div class="card shadow-none mb-4">
							...
							<div class="card-body">
								<div class="form-group col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
									...
									<input class="form-control" id="nama_kecamatan" name="nama_kecamatan" type="text" placeholder="Masukkkan nama kecamatan" value="<?= isset($_POST["nama_kecamatan"]) ? $_POST["nama_kecamatan"] : ''; ?>" onkeyup="this.value = this.value.toUpperCase();" />
									<?= form_error('nama_kecamatan', '<small class="text-danger pl-2">', '</small>'); ?>
								</div>
								<div class="form-group col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
									<label class="small mb-1" for="geojson">Geo JSON</label>
									<textarea class="form-control" id="geojson" name="geojson" type="text" rows="10" placeholder="Masukkan Geo JSON"></textarea>
								...
								<div class="form-group col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
									...
									<input class="form-control" id="latitude" name="latitude" type="text" placeholder="-1.234, 123.456" />
