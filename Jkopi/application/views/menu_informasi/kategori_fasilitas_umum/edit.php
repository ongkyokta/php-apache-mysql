              ...
              <div class="row align-items-center justify-content-between">
                <div class="col-auto mt-4">
                  <h1 class="page-header-title">
                    ...
                    Edit Data Kategori Fasilitas Umum
                  </h1>
        ...
        <div class="container mt-n10">
          <form method="POST" action="" enctype="multipart/form-data">
            <div class="card shadow-none mb-4">
              <div id="alert"><?php echo $this->session->flashdata('message') ?></div>
              <div class="card-header">Data Kategori Fasilitas Umum</div>
              <div class="card-body">
                <div class="form-group">
                  <div class="text-center">
                    <img class="img-account-profile mb-2" id="preview" src="<?= base_url() . $Kategori->gambar ?>" alt="" />
                ...
                <div class="form-row px-2">
                  <div class="form-group col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <label class="small mb-1" for="nama_kategori">Nama Fasilitas Kategori Fasilitas Umum</label>
                    <input class="form-control" id="nama_kategori" name="nama_kategori" type="text" placeholder="Masukkan nama fasilitas kategori fasilitas umum" value="<?= $Kategori->nama_kategori; ?>" />
