                        ...
                        <div class="card shadow-none mb-4">
                            ...
                            <div class="card-body">
                                <div class="form-group col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <input class="form-control" id="versi_aplikasi" name="versi_aplikasi" type="text" placeholder="Masukkan versi aplikasi" value="<?= $Versi->versi_aplikasi ?>" />
                                ...
                                <div class="form-group col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 px-2">
                                    ...
                                    <textarea class="form-control" id="deskripsi" name="deskripsi" type="text" rows="10"><?= $Versi->deskripsi ?></textarea>
